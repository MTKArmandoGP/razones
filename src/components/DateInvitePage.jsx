...
const dates = [
  {
    ...
    accent: "#c0606e",
    light: "#fce8ec",
    tag: "Una noche que no olvidarás",
    title: "Cenar bajo las estrellas\ny caminar sin prisa",
    description:
      "La idea es simple: encontrar un lugar rico donde cenar, sin reservaciones ni planes perfectos, solo nosotros eligiendo en el momento. Después caminar sin rumbo fijo, platicar de todo y de nada, reírnos de cosas que solo tienen sentido entre nosotros dos.",
    details: [
      { icon: "🍽️", text: "Cenar donde se nos antoje, tú eliges" },
      { icon: "🚶‍♂️", text: "Caminar sin prisa, sin destino" },
      { icon: "💬", text: "Platicar de todo lo que no hemos platicado" },
      { icon: "✨", text: "La noche decidirá el resto" },
    ],
    vibe: "tranquilo · íntimo · espontáneo",
    note: "Prometo que la conversación no va a tener fin ♡",
  },
  {
    id: "sunday",
    day: "Un domingo completo",
    emoji: "☀️",
    color: "#3b5a3a",
    accent: "#6aaa68",
    light: "#e8f5e8",
    tag: "Un día entero para nosotros",
    title: "Desayunar, explorar\ny perdernos juntos",
    description:
      "Un domingo como se debe vivir: empezar con un desayuno bien hecho, luego ir a un bazar a curiosear cosas raras, caminar entre puestos, ver qué nos llama la atención, quizá encontrar algo que ninguno esperaba. El objetivo es pasar tiempo de calidad, sin prisa de que se acabe el día.",
    details: [
      { icon: "🥐", text: "Desayuno tranquilo, el mejor plan matutino" },
      { icon: "🎨", text: "Bazar: libros, plantas, cosas raras y bonitas" },
      { icon: "🌿", text: "Caminar, explorar, descubrir rincones nuevos" },
      { icon: "🧋", text: "Un café o algo rico para el camino" },
      { icon: "💛", text: "Más tiempo juntos, que siempre es poco" },
    ],
    vibe: "aventurero · cálido · lleno de momentos",
    note: "Los domingos contigo suenan perfectos ♡",
  },
]
